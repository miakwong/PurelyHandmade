-- PurelyHandmade 数据库初始化 SQL 脚本
-- 此脚本包含所有创建表的 SQL 语句和初始数据
...
INSERT INTO `Category` 
    ...
    VALUES 
    (1,'Ceramics','ceramics','Handcrafted ceramic items','/category/ceramics.jpg','1','2025-03-23 18:23:13.000','2025-03-23 18:23:13.000'),
